...
class IlerlemeGoruntuleme extends StatefulWidget {
  const IlerlemeGoruntuleme({super.key});

  @override
  State<IlerlemeGoruntuleme> createState() => _IlerlemeGoruntulemeState();
}

class _IlerlemeGoruntulemeState extends State<IlerlemeGoruntuleme> {
